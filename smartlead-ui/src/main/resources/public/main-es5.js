...
var DashAdminComponent = /** @class */ (function () {
    function DashAdminComponent(restService) {
    ...
    DashAdminComponent.prototype.loadBusinessOverview = function (interval) {
        var _this = this;
        if (event) {
        ...
        this.restService.getBusinessOverviewForAdmin(interval).subscribe(function (businessOverview) {
            _this.businessOverview = businessOverview;
        });
    };
    DashAdminComponent.prototype.loadTeamTaskSummary = function (interval) {
        var _this = this;
        if (event) {
            event.preventDefault();
        }
        ...
        this.restService.getAllEmployees().subscribe(function (userList) {
            _this.restService.getTaskSummaryForAdmin(userList, interval).subscribe(function (teamTaskSummaryList) {
                _this.teamTaskSummaryList = teamTaskSummaryList;
            });
        });
    };
    DashAdminComponent.ctorParameters = function () { return [
...
var DashUserComponent = /** @class */ (function () {
    function DashUserComponent(restService, authenticationService) {
        this.restService = restService;
    ...
    DashUserComponent.prototype.loadTaskSummary = function (interval) {
        var _this = this;
        if (event) {
            event.preventDefault();
        }
        ...
        this.restService.getTaskSummaryForUser(this.authenticationService.getUser().userId, interval).subscribe(function (taskSummary) {
            _this.taskSummary = taskSummary;
        });
    };
    DashUserComponent.ctorParameters = function () { return [
        { type: src_app_services_rest_service__WEBPACK_IMPORTED_MODULE_2__["RestService"] },
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(authenticationService) {
        this.authenticationService = authenticationService;
        var loggedInUser = this.authenticationService.getUser();
...
var ListLeadsComponent = /** @class */ (function () {
    function ListLeadsComponent(formBuilder, restService) {
    ...
    ListLeadsComponent.prototype.searchLeads = function () {
        var searchModel = new src_app_models_search_model__WEBPACK_IMPORTED_MODULE_3__["SearchModel"]();
        searchModel.searchTerm = this.searchForm.get('searchText').value;
        var fieldFilters = [];
        if (this.leadStageValue !== 0) {
            var leadStageFilter = new src_app_models_field_filter__WEBPACK_IMPORTED_MODULE_4__["FieldFilter"]();
        ...
        if (this.leadSourceValue !== 0) {
            var leadSourceFilter = new src_app_models_field_filter__WEBPACK_IMPORTED_MODULE_4__["FieldFilter"]();
        ...
        if (this.ownerValue !== 0) {
            var ownerFilter = new src_app_models_field_filter__WEBPACK_IMPORTED_MODULE_4__["FieldFilter"]();
    ...
    ListLeadsComponent.prototype.enableEditMode = function (e, i) {
    ...
    ListLeadsComponent.prototype.saveRowData = function (rowData) {
        this.enableEditIndex = null;
        console.log('rowData', rowData);
        this.restService.saveLead(rowData).subscribe(function (reponse) {
            console.log('reponse', reponse);
        }, function (error) {
            console.log('error', error);
        });
    };
    ListLeadsComponent.prototype.delteItem = function (id) {
        if (confirm('Confirm Lead deletion?')) {
            // delete and load grid
            this.searchLeads();
        }
    };
    ListLeadsComponent.prototype.loadLeadSources = function () {
        var _this = this;
        this.restService.getLeadSources().subscribe(function (leadSources) {
            _this.leadSources = leadSources;
        });
    };
    ListLeadsComponent.prototype.loadLeadStages = function () {
        var _this = this;
        this.restService.getLeadStages().subscribe(function (leadStages) {
            _this.leadStages = leadStages;
        });
    };
    ListLeadsComponent.prototype.loadLeadOwners = function () {
        var _this = this;
        this.restService.getLeadOwners().subscribe(function (leadOwners) {
            _this.leadOwners = leadOwners;
        });
    };
    ListLeadsComponent.prototype.doSearch = function (searchModel) {
        var _this = this;
        var pageableModel = new src_app_models_pageable_model__WEBPACK_IMPORTED_MODULE_6__["PageableModel"]();
        pageableModel.page = this.page - 1;
        pageableModel.size = this.pageSize;
        pageableModel.request = searchModel;
        this.restService.searchLeads(pageableModel).subscribe(function (page) {
            _this.leads = page.result;
            _this.recordsPerPage = _this.leads.length;
            _this.totalRecords = page.total;
        });
    };
    ListLeadsComponent.ctorParameters = function () { return [
...
var ListProjectsComponent = /** @class */ (function () {
    function ListProjectsComponent(formBuilder, ngbModal, restService) {
        this.formBuilder = formBuilder;
    ...
    ListProjectsComponent.prototype.searchProjects = function () {
        var _this = this;
        var searchModel = new src_app_models_search_model__WEBPACK_IMPORTED_MODULE_5__["SearchModel"]();
        searchModel.searchTerm = this.searchForm.get('searchText').value;
        this.restService.searchProjects(searchModel).subscribe(function (projects) {
            _this.projects = projects;
        });
    };
    ListProjectsComponent.prototype.editItem = function (id) {
        var _this = this;
        var modalRef = this.ngbModal.open(_save_project_save_project_component__WEBPACK_IMPORTED_MODULE_4__["SaveProjectComponent"], { size: 'xl', backdrop: 'static' });
    ...
    ListProjectsComponent.prototype.delteItem = function (id) {
        var _this = this;
        if (confirm('Confirm Project deletion?')) {
            this.restService.deleteProject(id).subscribe(function (response) {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(formBuilder, router, authenticationService, restService) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.authenticationService = authenticationService;
        this.restService = restService;
    ...
    LoginComponent.prototype.onSubmit = function (formData) {
        var loginRequest = formData;
        this.loading = true;
        this.login(loginRequest);
    };
    LoginComponent.prototype.login = function (loginRequest) {
        var _this = this;
        this.restService.login(loginRequest).subscribe(function (user) {
            _this.authenticationService.setUser(user);
            _this.router.navigate(['dashboard']);
        }, function (error) {
            _this.setAlert(error, src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_5__["EnumAlertType"].Error);
            _this.loading = false;
        });
    };
    LoginComponent.prototype.loadOrganizations = function () {
        var _this = this;
        this.restService.getOrganizations().subscribe(function (organizations) {
            _this.organizations = organizations;
        });
    };
    LoginComponent.prototype.setAlert = function (message, type) {
...
var NavBarComponent = /** @class */ (function () {
    function NavBarComponent(ngbModal, authenticationService) {
        this.ngbModal = ngbModal;
        this.authenticationService = authenticationService;
    }
    ...
    NavBarComponent.prototype.openSaveProjectModal = function () {
        event.preventDefault();
    ...
    NavBarComponent.prototype.openSaveLeadModal = function () {
        event.preventDefault();
    ...
    NavBarComponent.prototype.openSaveQuickLeadModal = function () {
        event.preventDefault();
    ...
    NavBarComponent.prototype.openListProjectsModal = function () {
        event.preventDefault();
    ...
    NavBarComponent.prototype.openListLeadsModal = function () {
        event.preventDefault();
    ...
    NavBarComponent.prototype.openUserProfileModal = function () {
        event.preventDefault();
...
var SaveDocumentComponent = /** @class */ (function () {
    function SaveDocumentComponent(activeModal, formBuilder, authService, restService) {
    ...
    SaveDocumentComponent.prototype.ngOnInit = function () {
        this.getDocumentTypes();
    };
    SaveDocumentComponent.prototype.onFileChange = function (event) {
        if (event.target.files && event.target.files.length) {
            var _a = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](event.target.files, 1), file = _a[0];
            this.attachment = file;
        }
    };
    SaveDocumentComponent.prototype.saveDocument = function (formData) {
        var _this = this;
        var document = formData;
        document.createdBy = this.authService.getUser().username;
        document.updatedBy = document.createdBy;
        var lead = new src_app_models_lead__WEBPACK_IMPORTED_MODULE_8__["Lead"]();
        lead.leadId = this.leadId;
        document.lead = lead;
        console.log(document);
        this.restService.addLeadDocument(this.leadId, document, this.attachment).subscribe(function (response) {
            _this.setAlert('Document added successfully to Lead', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_6__["EnumAlertType"].Success);
            _this.saveDocumentForm.reset();
        }, function (error) {
            console.error(error);
            _this.setAlert('Server side error in adding document', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_6__["EnumAlertType"].Error);
        });
    };
    SaveDocumentComponent.prototype.getDocumentTypes = function () {
        var _this = this;
        this.restService.getDocumentTypes().subscribe(function (documentTypes) {
            _this.documentTypes = documentTypes;
        });
    };
    SaveDocumentComponent.prototype.setAlert = function (message, type) {
        this.alert.message = message;
        this.alert.type = type;
    };
    SaveDocumentComponent.ctorParameters = function () { return [
...
var SaveLeadComponent = /** @class */ (function () {
    function SaveLeadComponent(activeModal, formBuilder, restService, authenticationService) {
        this.activeModal = activeModal;
        this.formBuilder = formBuilder;
        this.restService = restService;
        this.authenticationService = authenticationService;
    ...
    SaveLeadComponent.prototype.ngOnInit = function () {
        this.loadProjects();
        this.loadLeadSources();
        this.loadLeadStages();
    ...
    SaveLeadComponent.prototype.saveAndAddNew = function (formData) {
        this.saveLead(formData);
    };
    SaveLeadComponent.prototype.saveAndClose = function (formData) {
        this.saveLead(formData);
        this.activeModal.close();
    };
    SaveLeadComponent.prototype.saveLead = function (formData) {
        var _this = this;
        var lead = formData;
        lead.owner = this.loggedInUser;
        lead.createdBy = this.loggedInUser.username;
        lead.modifiedBy = this.loggedInUser.username;
        this.restService.addLead(lead).subscribe(function (response) {
            _this.setAlert('Lead added successfully', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_6__["EnumAlertType"].Success);
            _this.saveLeadForm.reset();
        }, function (error) {
            _this.setAlert(error.message, src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_6__["EnumAlertType"].Error);
        });
    };
    SaveLeadComponent.prototype.loadProjects = function () {
        var _this = this;
        this.restService.getProjects().subscribe(function (projects) {
            _this.projects = projects;
        });
    };
    SaveLeadComponent.prototype.loadLeadSources = function () {
        var _this = this;
        this.restService.getLeadSources().subscribe(function (leadSources) {
            _this.leadSources = leadSources;
        });
    };
    SaveLeadComponent.prototype.loadLeadStages = function () {
        var _this = this;
        this.restService.getLeadStages().subscribe(function (leadStages) {
            _this.leadStages = leadStages;
        });
    };
    SaveLeadComponent.prototype.setAlert = function (message, type) {
        this.alert.message = message;
        this.alert.type = type;
    };
    SaveLeadComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
        { type: src_app_services_rest_service__WEBPACK_IMPORTED_MODULE_4__["RestService"] },
...
var SaveNoteComponent = /** @class */ (function () {
    function SaveNoteComponent(activeModal, formBuilder, authService, restService) {
        this.activeModal = activeModal;
        this.formBuilder = formBuilder;
        this.authService = authService;
        this.restService = restService;
    ...
    SaveNoteComponent.prototype.onFileChange = function (event) {
        if (event.target.files && event.target.files.length) {
            var _a = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](event.target.files, 1), file = _a[0];
            this.attachment = file;
        }
    };
    SaveNoteComponent.prototype.saveNote = function (formData) {
        var _this = this;
        var note = formData;
        ...
        var lead = new src_app_models_lead__WEBPACK_IMPORTED_MODULE_7__["Lead"]();
        lead.leadId = this.leadId;
        note.lead = lead;
        console.log(note);
        this.restService.addLeadNote(this.leadId, note, this.attachment).subscribe(function (response) {
            _this.setAlert('Note added successfully to Lead', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_5__["EnumAlertType"].Success);
            _this.saveNoteForm.reset();
        }, function (error) {
            console.error(error);
            _this.setAlert('Server side error in adding note', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_5__["EnumAlertType"].Error);
        });
    };
    SaveNoteComponent.prototype.setAlert = function (message, type) {
        this.alert.message = message;
        this.alert.type = type;
    };
    SaveNoteComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
        { type: src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"] },
...
var SaveProjectComponent = /** @class */ (function () {
    function SaveProjectComponent(activeModal, formBuilder, restService, authenticationService) {
        this.activeModal = activeModal;
        this.formBuilder = formBuilder;
        this.restService = restService;
        this.authenticationService = authenticationService;
    ...
    SaveProjectComponent.prototype.ngOnInit = function () {
    ...
    SaveProjectComponent.prototype.onFileChange = function (event) {
        if (event.target.files && event.target.files.length) {
            var _a = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](event.target.files, 1), file = _a[0];
            this.attachment = file;
        }
    };
    SaveProjectComponent.prototype.getAmenitiesControls = function () {
        return this.saveProjectForm.get('amenities').controls;
    };
    SaveProjectComponent.prototype.saveProject = function (formData) {
        var _this = this;
        var selectedAmenities = this.saveProjectForm.value.amenities
            .map(function (v, i) { return v ? _this.amenities[i] : null; })
            .filter(function (v) { return v !== null; });
        var project = new src_app_models_project__WEBPACK_IMPORTED_MODULE_5__["Project"]();
        Object.assign(project, formData);
        project.amenities = selectedAmenities;
        if (this.projectId) {
            project.projectId = this.projectId;
            project.modifiedBy = this.loggedInUser.username;
            this.restService.saveProject(project, this.attachment).subscribe(function (response) {
                if (response.brochureName) {
                    _this.brochureName = response.brochureName;
                }
                _this.setAlert('Project updated successfully', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_6__["EnumAlertType"].Success);
            }, function (error) {
                console.error(error);
                _this.setAlert('Server side error in saving project', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_6__["EnumAlertType"].Error);
            });
        }
        else {
            project.createdBy = this.loggedInUser.username;
            project.modifiedBy = this.loggedInUser.username;
            this.restService.addProject(project, this.attachment).subscribe(function (response) {
                _this.setAlert('Project added successfully with id: ' + response.projectId, src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_6__["EnumAlertType"].Success);
                _this.saveProjectForm.reset();
            }, function (error) {
                console.error(error);
                _this.setAlert('Server side error in adding project', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_6__["EnumAlertType"].Error);
            });
        }
    };
    SaveProjectComponent.prototype.downLoadBrochure = function () {
        var _this = this;
        event.preventDefault();
        this.restService.downLoadBrochure(this.projectId).subscribe(function (response) {
            var blob = new Blob([response]);
            file_saver__WEBPACK_IMPORTED_MODULE_8__["saveAs"](blob, _this.brochureName);
        });
    };
    SaveProjectComponent.prototype.fetchProject = function (id) {
        var _this = this;
        this.restService.fetchProject(id).subscribe(function (project) {
            if (!project) {
                alert('Error: Project with id: ' + id + ' was not found');
                _this.activeModal.dismiss();
            }
            _this.saveProjectForm.patchValue({
            ...
            _this.brochureName = project.brochureName;
            _this.patchAmenities(project.amenities);
            console.log(project);
        });
    };
    SaveProjectComponent.prototype.patchAmenities = function (savedAmenities) {
        var that = this;
        var _loop_1 = function (i) {
            if (savedAmenities.filter(function (e) { return e.amenityId === that.amenities[i].amenityId; }).length > 0) {
                this_1.saveProjectForm.controls.amenities.controls[i].patchValue(true);
            }
            else {
                this_1.saveProjectForm.controls.amenities.controls[i].patchValue(false);
            }
        };
        var this_1 = this;
        for (var i = 0; i < that.amenities.length; i++) {
            _loop_1(i);
        }
    };
    SaveProjectComponent.prototype.loadProjectTypes = function () {
        var _this = this;
        this.restService.getProjectTypes().subscribe(function (projectTypes) {
            _this.projectTypes = projectTypes;
        });
    };
    SaveProjectComponent.prototype.loadProjectStages = function () {
        var _this = this;
        this.restService.getProjectStages().subscribe(function (projectStages) {
            _this.projectStages = projectStages;
        });
    };
    SaveProjectComponent.prototype.loadBuilders = function () {
        var _this = this;
        this.restService.getBuilders().subscribe(function (builders) {
            _this.builders = builders;
        });
    };
    SaveProjectComponent.prototype.loadAmenities = function () {
        var _this = this;
        this.restService.getAmenities().subscribe(function (amenities) {
            _this.amenities = amenities;
            _this.amenities.forEach(function (e) {
                var control = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](false);
                _this.saveProjectForm.controls.amenities.push(control);
            });
        });
    };
    SaveProjectComponent.prototype.setAlert = function (message, type) {
        this.alert.message = message;
        this.alert.type = type;
    };
    SaveProjectComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
        { type: src_app_services_rest_service__WEBPACK_IMPORTED_MODULE_4__["RestService"] },
        { type: src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_9__["AuthenticationService"] }
...
var SaveQuickLeadComponent = /** @class */ (function () {
    function SaveQuickLeadComponent(activeModal, formBuilder, restService, authenticationService) {
        this.activeModal = activeModal;
        this.formBuilder = formBuilder;
        this.restService = restService;
        this.authenticationService = authenticationService;
    ...
    SaveQuickLeadComponent.prototype.ngOnInit = function () {
        this.loadLeadSources();
        this.loggedInUser = this.authenticationService.getUser();
        this.setDefaultLeadStage();
    };
    SaveQuickLeadComponent.prototype.saveAndAddNew = function (formData) {
        this.saveLead(formData);
    };
    SaveQuickLeadComponent.prototype.saveAndClose = function (formData) {
        this.saveLead(formData);
        this.activeModal.close();
    };
    SaveQuickLeadComponent.prototype.setDefaultLeadStage = function () {
        var _this = this;
        this.restService.getDefaultLeadStage().subscribe(function (stage) {
            _this.defaultLeadStage = stage;
        });
    };
    SaveQuickLeadComponent.prototype.saveLead = function (formData) {
        var _this = this;
        var lead = formData;
        lead.owner = this.loggedInUser;
        lead.createdBy = this.loggedInUser.username;
        ...
        this.restService.addLead(lead).subscribe(function (response) {
            _this.setAlert('Lead added successfully', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_5__["EnumAlertType"].Success);
            _this.saveLeadForm.reset();
        }, function (error) {
            _this.setAlert(error.message, src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_5__["EnumAlertType"].Error);
        });
    };
    SaveQuickLeadComponent.prototype.loadLeadSources = function () {
        var _this = this;
        this.restService.getLeadSources().subscribe(function (leadSources) {
            _this.leadSources = leadSources;
        });
    };
    SaveQuickLeadComponent.prototype.setAlert = function (message, type) {
        this.alert.message = message;
        this.alert.type = type;
    };
    SaveQuickLeadComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
        { type: src_app_services_rest_service__WEBPACK_IMPORTED_MODULE_4__["RestService"] },
        { type: src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_7__["AuthenticationService"] }
...
var SaveTaskComponent = /** @class */ (function () {
    function SaveTaskComponent(activeModal, formBuilder, authenticationService, restService) {
        this.activeModal = activeModal;
        this.formBuilder = formBuilder;
        this.authenticationService = authenticationService;
        this.restService = restService;
    ...
    SaveTaskComponent.prototype.onFileChange = function (event) {
        if (event.target.files && event.target.files.length) {
            var _a = tslib__WEBPACK_IMPORTED_MODULE_0__["__read"](event.target.files, 1), file = _a[0];
            this.attachment = file;
        }
    };
    SaveTaskComponent.prototype.populateFormOnEdit = function () {
    ...
    SaveTaskComponent.prototype.saveTask = function (formData) {
        var _this = this;
        var task = new src_app_models_task__WEBPACK_IMPORTED_MODULE_6__["Task"]();
        if (this.task) {
            task.leadTaskId = this.task.leadTaskId;
        }
        task.taskType = this.taskType;
        task.owner = this.lead.owner;
        var lead = new src_app_models_lead__WEBPACK_IMPORTED_MODULE_4__["Lead"]();
        ...
        console.log(task);
        if (this.task) {
            this.restService.saveLeadTask(this.lead.leadId, task, this.attachment).subscribe(function (response) {
                _this.setAlert('Task saved successfully', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_7__["EnumAlertType"].Success);
                if (response.attachmentName) {
                    _this.attachmentName = response.attachmentName;
                }
            }, function (error) {
                console.error(error);
                _this.setAlert('Server side error in saving task', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_7__["EnumAlertType"].Error);
            });
        }
        else {
            this.restService.addLeadTask(this.lead.leadId, task, this.attachment).subscribe(function (response) {
                _this.saveTaskForm.reset();
                _this.setAlert('Task added successfully', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_7__["EnumAlertType"].Success);
            }, function (error) {
                console.error(error);
                _this.setAlert('Server side error in adding task', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_7__["EnumAlertType"].Error);
            });
        }
    };
    SaveTaskComponent.prototype.downLoadAttachment = function () {
        var _this = this;
        event.preventDefault();
        this.restService.downLoadTaskAttachment(this.task.lead.leadId, this.task.leadTaskId).subscribe(function (response) {
            var blob = new Blob([response]);
            file_saver__WEBPACK_IMPORTED_MODULE_12__["saveAs"](blob, _this.attachmentName);
        });
    };
    SaveTaskComponent.prototype.initTaskSpecificSettings = function () {
    ...
    SaveTaskComponent.prototype.setAlert = function (message, type) {
        this.alert.message = message;
        this.alert.type = type;
    };
    SaveTaskComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
        { type: src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_9__["AuthenticationService"] },
...
var TabActivityHistoryComponent = /** @class */ (function () {
    function TabActivityHistoryComponent(restService) {
        this.restService = restService;
    }
    TabActivityHistoryComponent.prototype.ngOnInit = function () {
        this.fetchActivityHistory(this.leadId);
    };
    TabActivityHistoryComponent.prototype.fetchActivityHistory = function (leadId) {
        var _this = this;
        this.activityIntervals = [];
        this.restService.getLeadActivities(leadId).subscribe(function (activities) {
            var intervalToday = new src_app_models_activity_interval__WEBPACK_IMPORTED_MODULE_2__["ActivityInterval"]();
            intervalToday.interval = 'Today';
            intervalToday.activities = [];
            var intervalOlder = new src_app_models_activity_interval__WEBPACK_IMPORTED_MODULE_2__["ActivityInterval"]();
            intervalOlder.interval = 'Older';
            intervalOlder.activities = [];
            activities.forEach(function (activity) {
                if (_this.isToday(activity.createdOn)) {
            ...
            if (intervalToday.activities.length > 0) {
                _this.activityIntervals.push(intervalToday);
            }
            if (intervalOlder.activities.length > 0) {
                _this.activityIntervals.push(intervalOlder);
            }
        }, function (error) {
            console.error(error);
        });
    };
    TabActivityHistoryComponent.prototype.isToday = function (createdOn) {
        var createdDate = new Date(Date.parse(createdOn));
        var today = new Date();
        return createdDate.getDate() == today.getDate() &&
            createdDate.getMonth() == today.getMonth() &&
            createdDate.getFullYear() == today.getFullYear();
    };
    TabActivityHistoryComponent.ctorParameters = function () { return [
    ...
    return TabActivityHistoryComponent;
}());
...
var TabDocumentsComponent = /** @class */ (function () {
    function TabDocumentsComponent(restService) {
        this.restService = restService;
    ...
    TabDocumentsComponent.prototype.onMouseover = function (index) {
        this.showItems = true;
        this.showItemsIndex = index;
    };
    TabDocumentsComponent.prototype.onMouseout = function (index) {
        this.showItems = false;
        this.showItemsIndex = index;
    };
    TabDocumentsComponent.prototype.deleteItem = function (leadDocumentId) {
        var _this = this;
        if (confirm('Confirm document deletion?')) {
            this.restService.deleteLeadDocument(this.leadId, leadDocumentId).subscribe(function (response) {
                console.log(response);
                _this.getDocuments(_this.leadId);
            }, function (error) {
                console.log(error);
            });
        }
    };
    TabDocumentsComponent.prototype.getDocuments = function (leadId) {
        var _this = this;
        this.restService.getLeadDocuments(leadId).subscribe(function (documents) {
            _this.documents = documents;
        });
    };
    TabDocumentsComponent.ctorParameters = function () { return [
        { type: src_app_services_rest_service__WEBPACK_IMPORTED_MODULE_2__["RestService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var TabLeadDetailsComponent = /** @class */ (function () {
    function TabLeadDetailsComponent() {
    }
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return TabLeadDetailsComponent;
}());
...
var TabNotesComponent = /** @class */ (function () {
    function TabNotesComponent(restService) {
        this.restService = restService;
    }
    TabNotesComponent.prototype.ngOnInit = function () {
        this.getNotes(this.leadId);
    };
    TabNotesComponent.prototype.getNotes = function (leadId) {
        var _this = this;
        this.restService.getLeadNotes(leadId).subscribe(function (notes) {
            _this.notes = notes;
        });
    };
    TabNotesComponent.ctorParameters = function () { return [
        { type: src_app_services_rest_service__WEBPACK_IMPORTED_MODULE_2__["RestService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var TabTasksComponent = /** @class */ (function () {
    function TabTasksComponent(ngbModal, restService) {
        this.ngbModal = ngbModal;
        this.restService = restService;
        this.showItems = false;
        this.showItemsIndex = null;
    }
    TabTasksComponent.prototype.ngOnInit = function () {
        this.getTasks(this.lead.leadId, '');
    };
    TabTasksComponent.prototype.filterTasks = function (event) {
        var status = event.target.value;
        console.log(status);
        this.getTasks(this.lead.leadId, status);
    };
    TabTasksComponent.prototype.onMouseover = function (index) {
        this.showItems = true;
        this.showItemsIndex = index;
    };
    TabTasksComponent.prototype.onMouseout = function (index) {
        this.showItems = false;
        this.showItemsIndex = index;
    };
    TabTasksComponent.prototype.getBorderStyle = function (status) {
        var style = '6px solid ';
    ...
    TabTasksComponent.prototype.editItem = function (leadTask) {
        var _this = this;
        var modalRef = this.ngbModal.open(_save_task_save_task_component__WEBPACK_IMPORTED_MODULE_5__["SaveTaskComponent"], { size: 'lg', backdrop: 'static' });
        ...
        modalRef.result.then(function (data) {
            _this.getTasks(_this.lead.leadId, '');
        }, function (reason) {
            _this.getTasks(_this.lead.leadId, '');
        });
    };
    TabTasksComponent.prototype.delteItem = function (leadTaskId) {
        var _this = this;
        if (confirm('Confirm Task deletion?')) {
            this.restService.deleteLeadTask(this.lead.leadId, leadTaskId).subscribe(function (response) {
                console.log(response);
                _this.getTasks(_this.lead.leadId, '');
            }, function (error) {
                console.log(error);
    ...
    TabTasksComponent.prototype.getTasks = function (leadId, status) {
        var _this = this;
        this.taskIntervals = [];
        this.restService.getLeadTasks(leadId, status).subscribe(function (tasks) {
            var intervalToday = new src_app_models_task_interval__WEBPACK_IMPORTED_MODULE_2__["TaskInterval"]();
            intervalToday.interval = 'Today';
            intervalToday.tasks = [];
            var intervalOlder = new src_app_models_task_interval__WEBPACK_IMPORTED_MODULE_2__["TaskInterval"]();
            intervalOlder.interval = 'Older';
            intervalOlder.tasks = [];
            tasks.forEach(function (task) {
                if (_this.isToday(task.createdOn)) {
            ...
            if (intervalToday.tasks.length > 0) {
                _this.taskIntervals.push(intervalToday);
            }
            if (intervalOlder.tasks.length > 0) {
                _this.taskIntervals.push(intervalOlder);
            }
        }, function (error) {
            console.error(error);
        });
    };
    TabTasksComponent.prototype.isToday = function (createdOn) {
        var createdDate = new Date(Date.parse(createdOn));
        var today = new Date();
        return createdDate.getDate() == today.getDate() &&
            createdDate.getMonth() == today.getMonth() &&
    ...
    TabTasksComponent.ctorParameters = function () { return [
...
var UserProfileComponent = /** @class */ (function () {
    function UserProfileComponent(activeModal, formBuilder, restService, authenticationService) {
        this.activeModal = activeModal;
        this.formBuilder = formBuilder;
        this.restService = restService;
        this.authenticationService = authenticationService;
    ...
    UserProfileComponent.prototype.onSubmit = function (formData) {
        var _this = this;
        var isValid = this.validateFormData(formData);
        if (!isValid) {
            return;
        }
        var user = formData;
        user.userId = this.userData.userId;
        this.restService.saveUserDetails(user).subscribe(function (user) {
            _this.authenticationService.setUser(user);
            _this.setAlert('User details updated successfully', src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_5__["EnumAlertType"].Success);
        }, function (error) {
            _this.setAlert(error.message, src_app_models_enum_alert_type__WEBPACK_IMPORTED_MODULE_5__["EnumAlertType"].Error);
            _this.loading = false;
        });
    };
    UserProfileComponent.prototype.loadUserData = function () {
    ...
    UserProfileComponent.prototype.validateFormData = function (formData) {
    ...
    UserProfileComponent.prototype.setAlert = function (message, type) {
        this.alert.message = message;
        this.alert.type = type;
    };
...
var ViewLeadComponent = /** @class */ (function () {
    function ViewLeadComponent(location, route, ngbModal, restService) {
    ...
    ViewLeadComponent.prototype.ngOnInit = function () {
        var leadId = this.route.snapshot.params['leadId'];
        if (!leadId) {
            this.location.back();
        }
        this.fetchLeadDetails(leadId);
    };
    ViewLeadComponent.prototype.goBack = function () {
        this.location.back();
    };
    ViewLeadComponent.prototype.openSaveTaskModal = function (taskType) {
        event.preventDefault();
        var modalRef = this.ngbModal.open(_save_task_save_task_component__WEBPACK_IMPORTED_MODULE_4__["SaveTaskComponent"], { size: 'lg', backdrop: 'static' });
        var component = modalRef.componentInstance;
        component.taskType = taskType;
        component.lead = this.lead;
    };
    ViewLeadComponent.prototype.openSaveNoteModal = function () {
        event.preventDefault();
        var modalRef = this.ngbModal.open(_save_note_save_note_component__WEBPACK_IMPORTED_MODULE_6__["SaveNoteComponent"], { backdrop: 'static' });
        modalRef.componentInstance.leadId = this.lead.leadId;
    };
    ViewLeadComponent.prototype.openSaveDocumentModal = function () {
        event.preventDefault();
        var modalRef = this.ngbModal.open(_save_document_save_document_component__WEBPACK_IMPORTED_MODULE_7__["SaveDocumentComponent"], { backdrop: 'static' });
        modalRef.componentInstance.leadId = this.lead.leadId;
    };
    ViewLeadComponent.prototype.fetchLeadDetails = function (leadId) {
        var _this = this;
        this.restService.fetchLead(leadId).subscribe(function (lead) {
            _this.lead = lead;
            _this.lead.ageInDays = _this.getAgeInDays(lead.createdOn);
        });
    };
    ViewLeadComponent.prototype.getAgeInDays = function (createdOn) {
        var diff = new Date().getTime() - new Date(createdOn).getTime();
...
var HttpConfigInterceptor = /** @class */ (function () {
    function HttpConfigInterceptor(authenticationService) {
        this.authenticationService = authenticationService;
    }
    HttpConfigInterceptor.prototype.intercept = function (request, next) {
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (event) {
            if (event instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpResponse"]) {
                if (_this.isLoginRequest(event.url)) {
                    var token_1 = event.headers.get('Authorization');
                    if (token_1) {
                        _this.authenticationService.setToken(token_1);
                    }
                }
            }
            return event;
            ...
            if (err.status && err.status === 403) {
                _this.authenticationService.forceLogout();
            }
            //const error = err.error.message || err.statusText;
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(err);
        }));
    };
    HttpConfigInterceptor.prototype.isLoginRequest = function (url) {
        return (url.substr(url.lastIndexOf('/')) === '/login');
    };
    HttpConfigInterceptor.prototype.sendTokenInRequest = function (url) {
...
var ActivityInterval = /** @class */ (function () {
...
var PageableModel = /** @class */ (function () {
...
var TaskInterval = /** @class */ (function () {
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(router, ngbModal) {
        this.router = router;
        this.ngbModal = ngbModal;
    }
    ...
    AuthenticationService.prototype.doLogout = function (forceLogout) {
...
var RestService = /** @class */ (function () {
    ...
    /** USER SERVICE start **/
    RestService.prototype.getOrganizations = function () {
    ...
    RestService.prototype.login = function (loginRequest) {
    ...
    RestService.prototype.saveUserDetails = function (user) {
    ...
    RestService.prototype.getAllEmployees = function () {
    ...
    RestService.prototype.getProjects = function () {
        var searchObj = new _models_search_model__WEBPACK_IMPORTED_MODULE_3__["SearchModel"]();
    ...
    RestService.prototype.searchProjects = function (searchObj) {
        return this.http.post(this.getAPIUrl(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].projectAPIPrefix, '/projects/search'), searchObj)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.handleError()));
    };
    RestService.prototype.fetchProject = function (projectId) {
    ...
    RestService.prototype.getProjectTypes = function () {
    ...
    RestService.prototype.getProjectStages = function () {
    ...
    RestService.prototype.getBuilders = function () {
    ...
    RestService.prototype.getAmenities = function () {
    ...
    RestService.prototype.addProject = function (project, file) {
    ...
    RestService.prototype.saveProject = function (project, file) {
        var formData = new FormData();
        formData.append('project', new Blob([
            JSON.stringify(project)
        ], {
    ...
    RestService.prototype.deleteProject = function (projectId) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'text/plain; charset=utf-8');
        return this.http.delete(this.getAPIUrl(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].projectAPIPrefix, '/projects/' + projectId), { headers: headers, responseType: 'text' })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.handleError()));
    };
    RestService.prototype.downLoadBrochure = function (projectId) {
    ...
    /** LEAD SERVICE start **/
    RestService.prototype.searchLeads = function (pageableModel) {
    ...
    RestService.prototype.fetchLead = function (leadId) {
    ...
    RestService.prototype.getLeadStages = function () {
    ...
    RestService.prototype.getDefaultLeadStage = function () {
    ...
    RestService.prototype.getLeadSources = function () {
    ...
    RestService.prototype.getLeadOwners = function () {
    ...
    RestService.prototype.addLead = function (lead) {
    ...
    RestService.prototype.saveLead = function (lead) {
    ...
    RestService.prototype.getDocumentTypes = function () {
    ...
    RestService.prototype.addLeadDocument = function (leadId, document, file) {
        var formData = new FormData();
    ...
    RestService.prototype.getLeadDocuments = function (leadId) {
    ...
    RestService.prototype.deleteLeadDocument = function (leadId, leadDocumentId) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'text/plain; charset=utf-8');
        return this.http.delete(this.getAPIUrl(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].leadAPIPrefix, '/leads/' + leadId, '/documents/') + leadDocumentId, { headers: headers, responseType: 'text' })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.handleError()));
    };
    RestService.prototype.addLeadNote = function (leadId, note, file) {
        var formData = new FormData();
    ...
    RestService.prototype.getLeadNotes = function (leadId) {
    ...
    RestService.prototype.deleteLeadNote = function (leadId, leadNoteId) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'text/plain; charset=utf-8');
        return this.http.delete(this.getAPIUrl(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].leadAPIPrefix, '/leads/' + leadId, '/notes/' + leadNoteId), { headers: headers, responseType: 'text' })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.handleError()));
    };
    RestService.prototype.addLeadTask = function (leadId, task, file) {
        var formData = new FormData();
    ...
    RestService.prototype.saveLeadTask = function (leadId, task, file) {
        var formData = new FormData();
        formData.append('task', new Blob([
            JSON.stringify(task)
        ], {
    ...
    RestService.prototype.getLeadTasks = function (leadId, status) {
    ...
    RestService.prototype.deleteLeadTask = function (leadId, leadTaskId) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'text/plain; charset=utf-8');
        return this.http.delete(this.getAPIUrl(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].leadAPIPrefix, '/leads/' + leadId, '/tasks/' + leadTaskId), { headers: headers, responseType: 'text' })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.handleError()));
    };
    RestService.prototype.downLoadTaskAttachment = function (leadId, leadTaskId) {
    ...
    RestService.prototype.getTaskSummaryForUser = function (userId, interval) {
    ...
    RestService.prototype.getBusinessOverviewForAdmin = function (interval) {
    ...
    RestService.prototype.getTaskSummaryForAdmin = function (users, interval) {
    ...
    RestService.prototype.getLeadActivities = function (leadId) {
    ...
    RestService.prototype.getAPIUrl = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl;
    ...
    RestService.prototype.handleLoginError = function () {
        return function (error) {
            if (error.status === 403) {
